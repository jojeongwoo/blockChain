...
namespace eosio {
   ...
   class [[eosio::contract("eosio.token")]] token : public contract {
      public:
          ...
          */
         [[eosio::action]]
         void updatesheet( name user, 
                          std::string doctor, 
                          std::string patient, 
                          std::string diseaseCode, 
                          asset diseaseBalance
                          );

         [[eosio::action]]
         void payment( const name&    from,
                     const name&    to,
                     const asset&   quantity
                     );

         [[eosio::action]]
         void insurance( const name&    from,
                        const name&    to,
                        const asset&   quantity
                        );
         ...
         using updatesheet_action = eosio::action_wrapper<"updatesheet"_n, &token::updatesheet>;
         using payment_action = eosio::action_wrapper<"payment"_n, &token::payment>;
         using insurance_action = eosio::action_wrapper<"insurance"_n, &token::insurance>;
         using show_action = eosio::action_wrapper<"show"_n, &token::show>;
         using create_action = eosio::action_wrapper<"create"_n, &token::create>;
         using issue_action = eosio::action_wrapper<"issue"_n, &token::issue>;
         using retire_action = eosio::action_wrapper<"retire"_n, &token::retire>;
         using eraser_action = eosio::action_wrapper<"eraser"_n, &token::eraser>;
      ...
      private:
         ...
         void checkbalance( const name& from, const asset& token );
         void insurancebalance( const name& to, const asset& quantity, const name& from );
   };
